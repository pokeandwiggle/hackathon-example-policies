...
DATA_DIR = pathlib.Path("/root/autodl-tmp/stack_red_blocks_100")
...
cfg.job_name = "smolvla_stack_red_blocks_100" # "ditflow_sort_red_blocks_80"
cfg.output_dir = pathlib.Path("/root/autodl-tmp/outputs/smolvla_stack_red_blocks_100/")
cfg.save_freq = 10000
cfg.steps = 30000
cfg.log_freq = 100
# cfg.save_freq = 5
