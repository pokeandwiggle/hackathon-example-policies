...
DATA_DIR = pathlib.Path("/root/autodl-tmp/sort_red_blocks_100")

# Select one of the following configurations
from example_policies.config_factory import diffusion_config, dit_flow_config, dit_flow_image_config, smolvla_config

# cfg = dit_flow_config(DATA_DIR, enable_wandb=False)
cfg = smolvla_config(DATA_DIR, enable_wandb=False)
...
cfg.job_name = "smolvla_sort_red_blocks_100" # "ditflow_sort_red_blocks_80"
# cfg.output_dir = pathlib.Path("/root/autodl-tmp/outputs/smolvla_sort_red_blocks_100/")
cfg.save_freq = 10000
cfg.steps = 60000
cfg.log_freq = 100
# cfg.save_freq = 5
...
cfg.policy.scheduler_decay_steps=60000
